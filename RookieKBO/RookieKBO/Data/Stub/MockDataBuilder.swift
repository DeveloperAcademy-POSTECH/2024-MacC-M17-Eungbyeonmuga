    ...
    static var mockMatchList: [Match] {
        ...
        return [
            Match(
                ...
                season: "포스트 시즌",
                scoreBoard: [
                    ScoreBoard(homeAndAway: .HOME, runs: 5, hits: 8, errors: 1, balls: 15, scores: [1, 1, 1, 0, 1, 0, 1, 0 ]),
                    ScoreBoard(homeAndAway: .AWAY, runs: 2, hits: 7, errors: 0, balls: 5, scores: [0, 0, 0, 0, 0, 0, 0, 1, 1])
                ]
            ),
            Match(
                startDateTime: calendar.date(bySettingHour: 14, minute: 0, second: 0, of: calendar.date(byAdding: .day, value: 0, to: now)!)!,
                gameState: .PLAYING,
                homeTeam: Team(name: "키움 히어로즈", image: "kiwoomUnder", color: "kiwoom", backgroundImage: "kiwoomBg"),
                awayTeam: Team(name: "롯데 자이언츠", image: "lotteUnder", color: "lotte", backgroundImage: "lotteBg"),
                place: "수원 위즈 파크",
                season: "포스트 시즌",
                scoreBoard: [
                    ScoreBoard(homeAndAway: .HOME, runs: 3, hits: 2, errors: 3, balls: 4, scores: [1, 2, 0, 0]),
                    ScoreBoard(homeAndAway: .AWAY, runs: 0, hits: 6, errors: 7, balls: 8, scores: [0, 0, 0, 0])
                ]
            ),
            Match(
                startDateTime: calendar.date(bySettingHour: 18, minute: 30, second: 0, of: calendar.date(byAdding: .day, value: 0, to: now)!)!,
            ...
            Match(
                startDateTime: calendar.date(bySettingHour: 14, minute: 0, second: 0, of: calendar.date(byAdding: .day, value: 1, to: now)!)!,
            ...
            Match(
                ...
                season: "포스트 시즌",
                scoreBoard: [
                    ScoreBoard(homeAndAway: .HOME, runs: 5, hits: 8, errors: 1, balls: 15, scores: [1, 1, 1, 0, 1, 0, 1 ]),
                    ScoreBoard(homeAndAway: .AWAY, runs: 0, hits: 7, errors: 0, balls: 5, scores: [0, 0, 0, 0, 0, 0, 0])
                ]
            ),
            Match(
                startDateTime: calendar.date(bySettingHour: 14, minute: 0, second: 0, of: calendar.date(byAdding: .day, value: 2, to: now)!)!,
                gameState: .PREPARE,
            ...
            Match(
                startDateTime: calendar.date(bySettingHour: 18, minute: 30, second: 0, of: calendar.date(byAdding: .hour, value: 1, to: now)!)!,
                gameState: .PLAYING,
