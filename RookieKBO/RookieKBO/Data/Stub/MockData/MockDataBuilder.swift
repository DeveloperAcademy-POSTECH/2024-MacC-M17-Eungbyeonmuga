...
struct MockDataBuilder {
    static var mockTranscript: VideoTranscript {
        return VideoTranscript(
            videoId: "video1",
            transcript: [
                TranscriptItem(id: "", text: "박성한이 백투백 홈런", description: "", start: 0.0),
                TranscriptItem(id: "", text: "백투 홈런", description: "", start: 10.0),
                TranscriptItem(id: "", text: "않타", description: "", start: 5.5),
                TranscriptItem(id: "", text: "중견수", description: "", start: 15.5),
                TranscriptItem(id: "", text: "박성한이 도루함", description: "", start: 12.0),
                TranscriptItem(id: "" , text: "도루", description: "", start: 22.0),
                TranscriptItem(id: "" , text: "박성한이 홈런", description: "", start: 20.0),
                TranscriptItem(id: "", text: "홈런", description: "", start: 40.0),
                TranscriptItem(id: "", text: "박성한이 사이클링 히트", description: "",  start: 30.0),
                TranscriptItem(id: "", text: "사이클링 히트", description: "", start: 100.0),
                TranscriptItem(id: "", text: "사이클링 히트", description: "", start: 110.0),
            ]
        )
    }
